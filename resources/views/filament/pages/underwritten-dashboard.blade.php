        ...
        <div style="flex:1; min-height:0; overflow-y:auto; padding:20px;">
            ...
            @if ($activeTab === 'portfolio')
                ...
                <div class="dg-row">
                    ...
                    <div class="dg-questions">
                        ...
                        <div class="dg-q" x-show="lang === 'en'">How has our portfolio evolved with a specific reinsurer over time?</div>
                        <div class="dg-q" x-show="lang === 'en'">Is growth driven by the whole market or concentrated in a single reinsurer?</div>
                        <div class="dg-q" x-show="lang === 'es'">¿Cómo ha evolucionado el portfolio con una reaseguradora específica a lo largo del tiempo?</div>
                        <div class="dg-q" x-show="lang === 'es'">¿El crecimiento es impulsado por todo el mercado o por una sola reaseguradora?</div>
                    </div>
                </div>
                ...
                <div class="dg-row">
                    ...
                    <div class="dg-questions">
                        <div class="dg-q-label" x-text="lang === 'en' ? 'Questions it helps answer' : 'Preguntas que ayuda a responder'"></div>
                        <div class="dg-q" x-show="lang === 'en'">At what rate has our premium portfolio grown since we started operations?</div>
                        <div class="dg-q" x-show="lang === 'en'">Has growth been sustained, or were there periods of significant contraction?</div>
                        <div class="dg-q" x-show="lang === 'es'">¿A qué ritmo ha crecido nuestro portfolio de primas desde que iniciamos operaciones?</div>
                        <div class="dg-q" x-show="lang === 'es'">¿El crecimiento ha sido sostenido o hubo períodos de contracción significativa?</div>
                    </div>
                </div>
                ...
                <div class="dg-row">
                    ...
                    <div class="dg-questions">
                        <div class="dg-q-label" x-text="lang === 'en' ? 'Questions it helps answer' : 'Preguntas que ayuda a responder'"></div>
                        <div class="dg-q" x-show="lang === 'en'">How much have we accumulated in gross premiums since the business began?</div>
                        <div class="dg-q" x-show="lang === 'en'">What is the total historical size of our underwriting portfolio?</div>
                        <div class="dg-q" x-show="lang === 'es'">¿Cuánto hemos acumulado en primas brutas desde que inició el negocio?</div>
                        <div class="dg-q" x-show="lang === 'es'">¿Cuál es el tamaño total histórico de nuestro portfolio?</div>
                    </div>
                </div>
                ...
                <div class="dg-row">
                    ...
                    <div class="dg-questions">
                        <div class="dg-q-label" x-text="lang === 'en' ? 'Questions it helps answer' : 'Preguntas que ayuda a responder'"></div>
                        <div class="dg-q" x-show="lang === 'en'">Which was our best year in terms of production?</div>
                        <div class="dg-q" x-show="lang === 'en'">Have we already surpassed our all-time record, or does it still stand as the peak?</div>
                        <div class="dg-q" x-show="lang === 'es'">¿Cuál fue nuestro mejor año en términos de producción?</div>
                        <div class="dg-q" x-show="lang === 'es'">¿Hemos superado ya nuestro récord histórico, o sigue siendo el pico máximo?</div>
                    </div>
                </div>
                ...
                <div class="dg-row">
                    ...
                    <div class="dg-questions">
                        <div class="dg-q-label" x-text="lang === 'en' ? 'Questions it helps answer' : 'Preguntas que ayuda a responder'"></div>
                        <div class="dg-q" x-show="lang === 'en'">Are we expanding or concentrating our reinsurer base?</div>
                        <div class="dg-q" x-show="lang === 'en'">Did we gain or lose active reinsurers compared to the prior year?</div>
                        <div class="dg-q" x-show="lang === 'es'">¿Estamos ampliando o concentrando nuestra base de reaseguradoras?</div>
                        <div class="dg-q" x-show="lang === 'es'">¿Ganamos o perdimos reaseguradoras activas respecto al año anterior?</div>
                    </div>
                </div>
                ...
                <div class="dg-row">
                    ...
                    <div class="dg-questions">
                        <div class="dg-q-label" x-text="lang === 'en' ? 'Questions it helps answer' : 'Preguntas que ayuda a responder'"></div>
                        <div class="dg-q" x-show="lang === 'en'">How much did the number of businesses grow in a given year vs. the previous one?</div>
                        <div class="dg-q" x-show="lang === 'en'">Which year has seen the highest growth rate since the business started?</div>
                        <div class="dg-q" x-show="lang === 'en'">In which year did we record the largest drop, and what might have caused it?</div>
                        <div class="dg-q" x-show="lang === 'en'">Is growth consistent over time, or were there particularly irregular years?</div>
                        <div class="dg-q" x-show="lang === 'es'">¿Cuánto creció el número de negocios de un año respecto del anterior?</div>
                        <div class="dg-q" x-show="lang === 'es'">¿Cuál ha sido el año con mayor crecimiento desde que inició el negocio?</div>
                        <div class="dg-q" x-show="lang === 'es'">¿En qué año registramos la mayor caída y a qué puede atribuirse?</div>
                        <div class="dg-q" x-show="lang === 'es'">¿La tendencia de crecimiento es consistente o hubo años irregulares?</div>
                    </div>
                </div>
                ...
                <div class="dg-row">
                    ...
                    <div class="dg-questions">
                        <div class="dg-q-label" x-text="lang === 'en' ? 'Questions it helps answer' : 'Preguntas que ayuda a responder'"></div>
                        <div class="dg-q" x-show="lang === 'en'">In which year was the highest premium volume generated?</div>
                        <div class="dg-q" x-show="lang === 'en'">Does premium growth follow the same trend as business count, or is there a divergence?</div>
                        <div class="dg-q" x-show="lang === 'en'">How much did premiums grow this year vs. the prior year?</div>
                        <div class="dg-q" x-show="lang === 'es'">¿En qué año se generó el mayor volumen de primas?</div>
                        <div class="dg-q" x-show="lang === 'es'">¿El crecimiento en primas sigue la misma tendencia que el número de negocios, o hay divergencia?</div>
                        <div class="dg-q" x-show="lang === 'es'">¿Cuánto crecieron las primas este año vs. el año anterior?</div>
                    </div>
                </div>
            ...
            @elseif ($activeTab === 'budget_plan')
                ...
                <div class="dg-row">
                    ...
                    <div class="dg-questions">
                        <div class="dg-q-label" x-text="lang === 'en' ? 'Questions it helps answer' : 'Preguntas que ayuda a responder'"></div>
                        <div class="dg-q" x-show="lang === 'en'">How do the results of a specific year compare against the prior year?</div>
                        <div class="dg-q" x-show="lang === 'es'">¿Cómo se comparan los resultados de un año específico contra el anterior?</div>
                    </div>
                </div>
                ...
                <div class="dg-row">
                    ...
                    <div class="dg-questions">
                        <div class="dg-q-label" x-text="lang === 'en' ? 'Questions it helps answer' : 'Preguntas que ayuda a responder'"></div>
                        <div class="dg-q" x-show="lang === 'en'">How did a specific reinsurer perform in the selected year vs. its own prior year?</div>
                        <div class="dg-q" x-show="lang === 'es'">¿Cómo se desempeñó una reaseguradora específica en el año seleccionado vs. su propio año anterior?</div>
                    </div>
                </div>
                ...
                <div class="dg-row">
                    ...
                    <div class="dg-questions">
                        <div class="dg-q-label" x-text="lang === 'en' ? 'Questions it helps answer' : 'Preguntas que ayuda a responder'"></div>
                        <div class="dg-q" x-show="lang === 'en'">Are we on track to meet the budget we set for this year?</div>
                        <div class="dg-q" x-show="lang === 'en'">How far are we from the plan in terms of premium and business count?</div>
                        <div class="dg-q" x-show="lang === 'es'">¿Estamos alcanzando el presupuesto que nos fijamos para este año?</div>
                        <div class="dg-q" x-show="lang === 'es'">¿Qué tan lejos estamos del plan en primas y en número de negocios?</div>
                    </div>
                </div>
                ...
                <div class="dg-row">
                    ...
                    <div class="dg-questions">
                        <div class="dg-q-label" x-text="lang === 'en' ? 'Questions it helps answer' : 'Preguntas que ayuda a responder'"></div>
                        <div class="dg-q" x-show="lang === 'en'">How much did we generate in gross premiums in the selected year?</div>
                        <div class="dg-q" x-show="lang === 'en'">Are we above or below the prior year?</div>
                        <div class="dg-q" x-show="lang === 'en'">How close are we to reaching the budgeted plan?</div>
                        <div class="dg-q" x-show="lang === 'es'">¿Cuánto generamos en primas brutas en el año seleccionado?</div>
                        <div class="dg-q" x-show="lang === 'es'">¿Estamos por encima o por debajo del año anterior?</div>
                        <div class="dg-q" x-show="lang === 'es'">¿Qué tan cerca estamos de alcanzar el plan presupuestado?</div>
                    </div>
                </div>
                ...
                <div class="dg-row">
                    ...
                    <div class="dg-questions">
                        <div class="dg-q-label" x-text="lang === 'en' ? 'Questions it helps answer' : 'Preguntas que ayuda a responder'"></div>
                        <div class="dg-q" x-show="lang === 'en'">Did we place more or fewer businesses than the prior year?</div>
                        <div class="dg-q" x-show="lang === 'en'">Is premium growth accompanied by matching growth in business volume?</div>
                        <div class="dg-q" x-show="lang === 'es'">¿Colocamos más o menos negocios que el año anterior?</div>
                        <div class="dg-q" x-show="lang === 'es'">¿El crecimiento en prima va acompañado de un crecimiento en volumen de negocios?</div>
                    </div>
                </div>
                ...
                <div class="dg-row">
                    ...
                    <div class="dg-questions">
                        <div class="dg-q-label" x-text="lang === 'en' ? 'Questions it helps answer' : 'Preguntas que ayuda a responder'"></div>
                        <div class="dg-q" x-show="lang === 'en'">Which reinsurer holds the largest share of our portfolio?</div>
                        <div class="dg-q" x-show="lang === 'en'">Do we have a risky concentration in a single reinsurer?</div>
                        <div class="dg-q" x-show="lang === 'en'">Which reinsurers are growing and which are losing share vs. the prior year?</div>
                        <div class="dg-q" x-show="lang === 'es'">¿Qué reaseguradora concentra la mayor proporción de nuestro portfolio?</div>
                        <div class="dg-q" x-show="lang === 'es'">¿Tenemos una concentración riesgosa en una sola reaseguradora?</div>
                        <div class="dg-q" x-show="lang === 'es'">¿Qué reaseguradoras están creciendo y cuáles perdiendo participación vs. el año anterior?</div>
                    </div>
                </div>
                ...
                <div class="dg-row">
                    ...
                    <div class="dg-questions">
                        <div class="dg-q-label" x-text="lang === 'en' ? 'Questions it helps answer' : 'Preguntas que ayuda a responder'"></div>
                        <div class="dg-q" x-show="lang === 'en'">In which months of the year is production most concentrated?</div>
                        <div class="dg-q" x-show="lang === 'en'">Are we tracking in line with last year's pace year-to-date?</div>
                        <div class="dg-q" x-show="lang === 'en'">Is there a clear seasonal pattern in our business?</div>
                        <div class="dg-q" x-show="lang === 'es'">¿En qué meses del año se concentra la mayor producción?</div>
                        <div class="dg-q" x-show="lang === 'es'">¿Estamos en línea con el ritmo del año anterior en lo que va del año?</div>
                        <div class="dg-q" x-show="lang === 'es'">¿Hay estacionalidad marcada en nuestro negocio?</div>
                    </div>
                </div>
            ...
            @elseif ($activeTab === 'segmentation')
                ...
                <div class="dg-row">
                    ...
                    <div class="dg-questions">
                        <div class="dg-q-label" x-text="lang === 'en' ? 'Questions it helps answer' : 'Preguntas que ayuda a responder'"></div>
                        <div class="dg-q" x-show="lang === 'en'">How has the reinsurer segmentation changed from one year to the next?</div>
                        <div class="dg-q" x-show="lang === 'es'">¿Cómo ha cambiado la segmentación de reaseguradoras de un año a otro?</div>
                    </div>
                </div>
                ...
                <div class="dg-row">
                    ...
                    <div class="dg-questions">
                        <div class="dg-q-label" x-text="lang === 'en' ? 'Questions it helps answer' : 'Preguntas que ayuda a responder'"></div>
                        <div class="dg-q" x-show="lang === 'en'">How many distinct groups of reinsurers exist based on premium volume?</div>
                        <div class="dg-q" x-show="lang === 'en'">What share of the total portfolio does the largest group hold?</div>
                        <div class="dg-q" x-show="lang === 'en'">Is there a group of smaller reinsurers that together represent a significant volume?</div>
                        <div class="dg-q" x-show="lang === 'es'">¿Cuántos grupos diferenciados de reaseguradoras existen según su volumen de prima?</div>
                        <div class="dg-q" x-show="lang === 'es'">¿Qué proporción del portfolio total concentra el grupo más grande?</div>
                        <div class="dg-q" x-show="lang === 'es'">¿Hay un grupo de reaseguradoras más pequeñas que en conjunto representan un volumen significativo?</div>
                    </div>
                </div>
                ...
                <div class="dg-row">
                    ...
                    <div class="dg-questions">
                        <div class="dg-q-label" x-text="lang === 'en' ? 'Questions it helps answer' : 'Preguntas que ayuda a responder'"></div>
                        <div class="dg-q" x-show="lang === 'en'">Which reinsurers are most similar to each other in terms of premium volume?</div>
                        <div class="dg-q" x-show="lang === 'en'">Is there a reinsurer so dominant that it operates in its own category?</div>
                        <div class="dg-q" x-show="lang === 'en'">Which reinsurers would make sense to group together in a joint negotiation or strategy?</div>
                        <div class="dg-q" x-show="lang === 'es'">¿Qué reaseguradoras son más similares entre sí en términos de volumen de prima?</div>
                        <div class="dg-q" x-show="lang === 'es'">¿Existe alguna reaseguradora tan dominante que opera en una categoría propia?</div>
                        <div class="dg-q" x-show="lang === 'es'">¿Con qué reaseguradoras tendría sentido agrupar una negociación o estrategia conjunta?</div>
                    </div>
                </div>
            ...
            @elseif ($activeTab === 'gwp_distribution')
                ...
                <div class="dg-row">
                    ...
                    <div class="dg-questions">
                        <div class="dg-q-label" x-text="lang === 'en' ? 'Questions it helps answer' : 'Preguntas que ayuda a responder'"></div>
                        <div class="dg-q" x-show="lang === 'en'">How does this year's fee and premium structure compare to the prior year?</div>
                        <div class="dg-q" x-show="lang === 'es'">¿Cómo se compara la estructura de comisiones y primas de este año vs. el anterior?</div>
                    </div>
                </div>
                ...
                <div class="dg-row">
                    ...
                    <div class="dg-questions">
                        <div class="dg-q-label" x-text="lang === 'en' ? 'Questions it helps answer' : 'Preguntas que ayuda a responder'"></div>
                        <div class="dg-q" x-show="lang === 'en'">What is the cost and commission structure for a specific partner or combination of partners?</div>
                        <div class="dg-q" x-show="lang === 'en'">Is a particular cedant's net margin better or worse than the portfolio average?</div>
                        <div class="dg-q" x-show="lang === 'es'">¿Cuál es la estructura de costos y comisiones de un socio o combinación de socios específica?</div>
                        <div class="dg-q" x-show="lang === 'es'">¿El margen neto de un cedante particular es mejor o peor que el promedio del portfolio?</div>
                    </div>
                </div>
                ...
                <div class="dg-row">
                    ...
                    <div class="dg-questions">
                        <div class="dg-q-label" x-text="lang === 'en' ? 'Questions it helps answer' : 'Preguntas que ayuda a responder'"></div>
                        <div class="dg-q" x-show="lang === 'en'">How much did we generate in gross premiums with this group of partners in the selected year?</div>
                        <div class="dg-q" x-show="lang === 'en'">Did we grow or shrink vs. the prior year in this segment?</div>
                        <div class="dg-q" x-show="lang === 'es'">¿Cuánto generamos en prima bruta con este grupo de socios en el año seleccionado?</div>
                        <div class="dg-q" x-show="lang === 'es'">¿Crecimos o decrecimos vs. el año anterior en este segmento?</div>
                    </div>
                </div>
                ...
                <div class="dg-row">
                    ...
                    <div class="dg-questions">
                        <div class="dg-q-label" x-text="lang === 'en' ? 'Questions it helps answer' : 'Preguntas que ayuda a responder'"></div>
                        <div class="dg-q" x-show="lang === 'en'">What proportion of gross premium is allocated to each type of commission or fee?</div>
                        <div class="dg-q" x-show="lang === 'en'">Is the commission mix within expected parameters, or is any item out of range?</div>
                        <div class="dg-q" x-show="lang === 'es'">¿Qué proporción de la prima bruta se destina a cada tipo de comisión o cargo?</div>
                        <div class="dg-q" x-show="lang === 'es'">¿El mix de comisiones está dentro de los parámetros esperados o hay alguna partida fuera de rango?</div>
                    </div>
                </div>
                ...
                <div class="dg-row">
                    ...
                    <div class="dg-questions">
                        <div class="dg-q-label" x-text="lang === 'en' ? 'Questions it helps answer' : 'Preguntas que ayuda a responder'"></div>
                        <div class="dg-q" x-show="lang === 'en'">How much do we retain after all deductions?</div>
                        <div class="dg-q" x-show="lang === 'en'">Is the net margin improving or deteriorating vs. the prior year?</div>
                        <div class="dg-q" x-show="lang === 'en'">Which partner combination generates the best net margin?</div>
                        <div class="dg-q" x-show="lang === 'es'">¿Cuánto nos queda realmente después de todas las deducciones?</div>
                        <div class="dg-q" x-show="lang === 'es'">¿El margen neto está mejorando o deteriorándose vs. el año anterior?</div>
                        <div class="dg-q" x-show="lang === 'es'">¿Qué combinación de socios genera el mejor margen neto?</div>
                    </div>
                </div>
                ...
                <div class="dg-row">
                    ...
                    <div class="dg-questions">
                        <div class="dg-q-label" x-text="lang === 'en' ? 'Questions it helps answer' : 'Preguntas que ayuda a responder'"></div>
                        <div class="dg-q" x-show="lang === 'en'">Which reinsurer contributes the largest share of gross premium?</div>
                        <div class="dg-q" x-show="lang === 'en'">Is reinsurer concentration increasing or becoming more evenly distributed?</div>
                        <div class="dg-q" x-show="lang === 'es'">¿Qué reaseguradora aporta la mayor proporción de primas brutas?</div>
                        <div class="dg-q" x-show="lang === 'es'">¿La concentración por reaseguradora está aumentando o distribuyéndose más uniformemente?</div>
                    </div>
                </div>
                ...
                <div class="dg-row">
                    ...
                    <div class="dg-questions">
                        <div class="dg-q-label" x-text="lang === 'en' ? 'Questions it helps answer' : 'Preguntas que ayuda a responder'"></div>
                        <div class="dg-q" x-show="lang === 'en'">Which retrocession channel generates the highest premium volume?</div>
                        <div class="dg-q" x-show="lang === 'en'">Are we diversifying our channels or depending heavily on a single one?</div>
                        <div class="dg-q" x-show="lang === 'es'">¿Qué canal de retrocesión genera el mayor volumen de prima?</div>
                        <div class="dg-q" x-show="lang === 'es'">¿Estamos diversificando nuestros canales o dependemos de uno solo?</div>
                    </div>
                </div>
                ...
                <div class="dg-row">
                    ...
                    <div class="dg-questions">
                        <div class="dg-q-label" x-text="lang === 'en' ? 'Questions it helps answer' : 'Preguntas que ayuda a responder'"></div>
                        <div class="dg-q" x-show="lang === 'en'">Which cedant carries the greatest weight in our portfolio?</div>
                        <div class="dg-q" x-show="lang === 'en'">Do we have a client concentration that represents a portfolio risk?</div>
                        <div class="dg-q" x-show="lang === 'en'">Which cedants have grown or reduced their share vs. the prior year?</div>
                        <div class="dg-q" x-show="lang === 'es'">¿Qué cedante tiene el mayor peso en nuestro portfolio?</div>
                        <div class="dg-q" x-show="lang === 'es'">¿Tenemos una concentración de clientes que represente un riesgo de cartera?</div>
                        <div class="dg-q" x-show="lang === 'es'">¿Qué cedantes han crecido o reducido su participación vs. el año anterior?</div>
                    </div>
                </div>
