...
<x-filament-widgets::widget class="fi-wi-chart">
    ...
    {{-- Single Alpine scope: chartGuideOpen + lang live here --}}
    <div x-data="{ chartGuideOpen: false, lang: 'en' }">
        ...
        >
            <x-slot name="afterHeader">
                <button
                    type="button"
                    x-on:click.stop="chartGuideOpen = true"
        ...
        {{-- Slide-over panel (no nested x-data — inherits lang + chartGuideOpen from parent) --}}
        <div
            x-show="chartGuideOpen"
                ...
                <div style="display:flex; align-items:center; justify-content:space-between; padding:18px 20px 14px; border-bottom:1px solid light-dark(#e5e7eb,#27272a); flex-shrink:0;">
                    ...
                    <div style="display:flex; align-items:center; gap:8px;">
                        <div style="display:flex; border:1px solid light-dark(#d1d5db,#374151); border-radius:999px; overflow:hidden;">
                            <button type="button" @click="lang = 'en'" :style="lang === 'en' ? 'background:#41A2C3; color:#fff;' : ''" style="padding:3px 10px; font-size:11px; font-weight:700; border:none; cursor:pointer; background:transparent; color:light-dark(#6b7280,#9ca3af); transition:all .15s;">EN</button>
                            <button type="button" @click="lang = 'es'" :style="lang === 'es' ? 'background:#41A2C3; color:#fff;' : ''" style="padding:3px 10px; font-size:11px; font-weight:700; border:none; cursor:pointer; background:transparent; color:light-dark(#6b7280,#9ca3af); transition:all .15s;">ES</button>
                        </div>
