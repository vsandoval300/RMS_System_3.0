...
<div class="cg-wrap" x-data="{ lang: $store.cgLang ?? 'en' }">
    ...
    <ul class="cg-col-list">
        <li class="cg-col-item">
            ...
            <span class="cg-col-desc" x-show="lang==='en'">Unique numeric identifier for the reinsurer type record.</span>
            <span class="cg-col-desc" x-show="lang==='es'">Identificador numérico único del registro de tipo de reasegurador.</span>
        </li>
        <li class="cg-col-item">
            <span class="cg-col-name">Type Acronym</span>
            <span class="cg-col-desc" x-show="lang==='en'">Short code that categorizes the reinsurer by its operational model (e.g., PRO for Professional Reinsurer, CAP for Captive). Referenced when registering reinsurers in the system.</span>
            <span class="cg-col-desc" x-show="lang==='es'">Código corto que categoriza al reasegurador por su modelo operativo (ej. PRO para Reasegurador Profesional, CAP para Cautiva). Se referencia al registrar reaseguradores en el sistema.</span>
        </li>
        <li class="cg-col-item">
            <span class="cg-col-name" x-text="lang==='en'?'Description':'Descripción'"></span>
            <span class="cg-col-desc" x-show="lang==='en'">Full description of what the reinsurer type represents, including the business model and regulatory context that defines it.</span>
            <span class="cg-col-desc" x-show="lang==='es'">Descripción completa de lo que representa el tipo de reasegurador, incluido el modelo de negocio y el contexto regulatorio que lo define.</span>
        </li>
    </ul>
