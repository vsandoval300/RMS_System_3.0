...
<div class="cg-wrap" x-data="{ lang: $store.cgLang ?? 'en' }">
    ...
    <ul class="cg-col-list">
        <li class="cg-col-item">
            ...
            <span class="cg-col-desc" x-show="lang==='en'">Unique numeric identifier for the subregion record.</span>
            <span class="cg-col-desc" x-show="lang==='es'">Identificador numérico único del registro de subregión.</span>
        </li>
        <li class="cg-col-item">
            <span class="cg-col-name" x-text="lang==='en'?'Name':'Nombre'"></span>
            <span class="cg-col-desc" x-show="lang==='en'">Full name of the subregion (e.g., Central America, Southern Europe, Southeast Asia). Subregions subdivide a macro-region into more specific geographic groupings.</span>
            <span class="cg-col-desc" x-show="lang==='es'">Nombre completo de la subregión (ej. América Central, Europa del Sur, Sudeste Asiático). Las subregiones subdividen una macro-región en agrupaciones geográficas más específicas.</span>
        </li>
        <li class="cg-col-item">
            <span class="cg-col-name">Subregion Code</span>
            <span class="cg-col-desc" x-show="lang==='en'">Short alphanumeric code used to identify the subregion internally. Used as a reference key when linking countries to this subregion.</span>
            <span class="cg-col-desc" x-show="lang==='es'">Código alfanumérico corto para identificar la subregión internamente. Se usa como clave de referencia al vincular países con esta subregión.</span>
        </li>
        <li class="cg-col-item">
            <span class="cg-col-name" x-text="lang==='en'?'Region':'Región'"></span>
            <span class="cg-col-desc" x-show="lang==='en'">Parent macro-region this subregion belongs to (e.g., Americas, Europe). Each subregion is linked to exactly one region.</span>
            <span class="cg-col-desc" x-show="lang==='es'">Macro-región padre a la que pertenece esta subregión (ej. Américas, Europa). Cada subregión está vinculada a exactamente una región.</span>
        </li>
    </ul>
