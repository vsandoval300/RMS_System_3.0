...
<div class="cg-wrap" x-data="{ lang: $store.cgLang ?? 'en' }">
    ...
    <ul class="cg-col-list">
        <li class="cg-col-item">
            ...
            <span class="cg-col-desc" x-show="lang==='en'">Unique numeric identifier for the operative status record.</span>
            <span class="cg-col-desc" x-show="lang==='es'">Identificador numérico único del registro de estado operativo.</span>
        </li>
        <li class="cg-col-item">
            <span class="cg-col-name">Acronym</span>
            <span class="cg-col-desc" x-show="lang==='en'">Short code that identifies the operative status (e.g., ACT, INA, SUS). This code is used as a quick reference across operative documents and reports.</span>
            <span class="cg-col-desc" x-show="lang==='es'">Código corto que identifica el estado operativo (ej. ACT, INA, SUS). Este código se usa como referencia rápida en documentos operativos e informes.</span>
        </li>
        <li class="cg-col-item">
            <span class="cg-col-name" x-text="lang==='en'?'Description':'Descripción'"></span>
            <span class="cg-col-desc" x-show="lang==='en'">Full description of what the operative status means and when it applies within the reinsurance lifecycle.</span>
            <span class="cg-col-desc" x-show="lang==='es'">Descripción completa de lo que significa el estado operativo y cuándo aplica dentro del ciclo de vida del reaseguro.</span>
        </li>
    </ul>
