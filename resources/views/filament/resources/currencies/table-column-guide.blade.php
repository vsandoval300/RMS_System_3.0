...
<div class="cg-wrap" x-data="{ lang: $store.cgLang ?? 'en' }">
    ...
    <ul class="cg-col-list">
        <li class="cg-col-item">
            ...
            <span class="cg-col-desc" x-show="lang==='en'">Unique numeric identifier assigned to each currency record.</span>
            <span class="cg-col-desc" x-show="lang==='es'">Identificador numérico único asignado a cada registro de moneda.</span>
        </li>
        <li class="cg-col-item">
            <span class="cg-col-name" x-text="lang==='en'?'Name':'Nombre'"></span>
            <span class="cg-col-desc" x-show="lang==='en'">Full official name of the currency (e.g., US Dollar, Euro, Mexican Peso).</span>
            <span class="cg-col-desc" x-show="lang==='es'">Nombre oficial completo de la moneda (ej. Dólar Estadounidense, Euro, Peso Mexicano).</span>
        </li>
        <li class="cg-col-item">
            <span class="cg-col-name">Acronym</span>
            <span class="cg-col-desc" x-show="lang==='en'">ISO 4217 three-letter currency code used in international transactions (e.g., USD, EUR, MXN). This code is referenced throughout the system when assigning a currency to businesses or documents.</span>
            <span class="cg-col-desc" x-show="lang==='es'">Código de tres letras ISO 4217 utilizado en transacciones internacionales (ej. USD, EUR, MXN). Este código es referenciado en todo el sistema al asignar una moneda a negocios o documentos.</span>
        </li>
    </ul>
