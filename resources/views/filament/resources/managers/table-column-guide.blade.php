...
<div class="cg-wrap" x-data="{ lang: $store.cgLang ?? 'en' }">
    ...
    <ul class="cg-col-list">
        <li class="cg-col-item">
            ...
            <span class="cg-col-desc" x-show="lang==='en'">Unique numeric identifier for the manager record.</span>
            <span class="cg-col-desc" x-show="lang==='es'">Identificador numérico único del registro de manager.</span>
        </li>
        <li class="cg-col-item">
            <span class="cg-col-name" x-text="lang==='en'?'Name':'Nombre'"></span>
            <span class="cg-col-desc" x-show="lang==='en'">Full name of the managing entity or individual. Managers are linked to reinsurance contracts as responsible underwriting contacts.</span>
            <span class="cg-col-desc" x-show="lang==='es'">Nombre completo de la entidad o persona gestora. Los managers se vinculan a contratos de reaseguro como contactos responsables de suscripción.</span>
        </li>
        <li class="cg-col-item">
            <span class="cg-col-name" x-text="lang==='en'?'Address':'Dirección'"></span>
            <span class="cg-col-desc" x-show="lang==='en'">Physical or registered address of the manager. Used for correspondence and compliance verification purposes.</span>
            <span class="cg-col-desc" x-show="lang==='es'">Dirección física o registrada del manager. Se utiliza para correspondencia y verificación de cumplimiento.</span>
        </li>
        <li class="cg-col-item">
            <span class="cg-col-name" x-text="lang==='en'?'Country':'País'"></span>
            <span class="cg-col-desc" x-show="lang==='en'">Country where the manager is based or legally registered. Relevant for jurisdictional and regulatory classification.</span>
            <span class="cg-col-desc" x-show="lang==='es'">País donde está radicado o registrado legalmente el manager. Relevante para la clasificación jurisdiccional y regulatoria.</span>
        </li>
    </ul>
