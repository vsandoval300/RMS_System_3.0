...
class ReinsurerBankAccountsRelationManager extends RelationManager
{
    ...
    public function form(Form $form): Form
    {
        return $form
            ->schema([
                Forms\Components\TextInput::make('bankAccount.beneficiary_acct_name')
                    ->required()
                    ->maxLength(255),
            ]);
    }
    ...
    {
        return $table
            ->recordTitleAttribute('bankAccount.beneficiary_acct_name')
            ->columns([
                Tables\Columns\TextColumn::make('bankAccount.beneficiary_acct_name'),
            ])
            ->filters([
                //
            ])
