                                    ...
                                    Section::make('Coverage Period')
                                            ...
                                            ->schema([
                                                    ...
                                                    DateTimePicker::make('inception_date')
                                                        ...
                                                        ->live()
                                                        ->afterStateHydrated(function (Set $set, $state, Get $get, $record) {
                                ...
                                Tab::make('Placement Schemes')
                                    ...
                                    ->schema([
                                        Repeater::make('schemes')
                                             ...
                                             */
                                            ->deleteAction(fn (Action $action) => $action->after(function (Set $set, Get $get) {
                                            ...
                                            ->schema([
                                                ...
                                                Repeater::make('insureds')
                                                    ...
                                                    ->schema([
                                                        ...
                                                        Select::make('cscheme_id')
                                                            ...
                                                            ->options(function (Get $get) {
                                                                ...
                                                                return CostScheme::whereIn('id', $ids)
                                                                    ->get()
                                                                    ->mapWithKeys(fn ($s) => [
                                                    ...
                                                    ->afterStateUpdated(function (array $state, Set $set) {
                                                        ...
                                                        $shareByScheme = CostScheme::query()
                    ...
                    ->schema([
                        View::make('filament.resources.business.operative-doc-summary_v1')
                            ...
                            ->viewData(function ($get, $record, $livewire) {
                                ...
                                $start = $inception  ? Carbon::parse($inception)->startOfDay() : null;
                                $end   = $expiration ? Carbon::parse($expiration)->startOfDay() : null;
        ...
        ->recordActions([
            ActionGroup::make([
                ...
                Action::make('cloneDoc')
                    ...
                    ->color('warning')
                    ->visible(fn ($record): bool => in_array((int) ($record?->operative_doc_type_id ?? 0), [2, 3, 4, 6, 7, 8]))
                    ->requiresConfirmation()
                    ->modalHeading(fn ($record) => 'Clone — ' . ($record->docType->name ?? 'Document') . ' #' . $record->index)
                    ->modalDescription(fn ($record) => 'A copy of document ' . $record->id . ' will be created with the next available index for this business. Schemes and insureds will be duplicated. Transactions are not included.')
                    ...
                    ->action(function ($record): void {
                        ...
                        DB::transaction(function () use ($record, &$newDocId, &$newIndex): void {
                            ...
                            // 3. Clone insureds (UUID auto-generated by booted()::creating)
                ...
                Action::make('addTransaction')
                    ...
                    ->disabled(function (): bool {
                        ...
                        return ! ($user?->can('Business:AddTransaction') ?? false);
                    })
                    ->tooltip(function (): ?string {
                        /** @var User|null $user */
                        $user = Filament::auth()->user();
                    ...
                    ->action(function ($record): void {
                        ...
                        if (! ($user?->can('Business:AddTransaction') ?? false)) {
                            Notification::make()
