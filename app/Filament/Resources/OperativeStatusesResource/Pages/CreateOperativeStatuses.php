...
class CreateOperativeStatuses extends CreateRecord
{
    ...
    protected function getCreatedNotification(): ?Notification
    {
        return Notification::make()
            ->success()
            ->title('Operative Status created')
            ->body('The new Operative Status has been created successfully.');
    }
    ...
    protected function getCreateFormAction(): Action
    {
        return Action::make('create')
            ...
            ->modalHeading('Create Operative Status')
            ->modalDescription('Are you sure you want to create this Operative Status?')
