...
class CreateCorporateDocuments extends CreateRecord
{
    ...
    protected function getCreatedNotification(): ?Notification
    {
        return Notification::make()
            ->success()
            ->title('Corporate Document created')
            ->body('The new Corporate Document has been created successfully.');
    }
    ...
    protected function getCreateFormAction(): Action
    {
        return Action::make('create')
            ...
            ->modalHeading('Create Corporate Document')
            ->modalDescription('Are you sure you want to create this Corporate Document?')
